/// @function scr_player_animate_egg
function scr_player_animate_egg()
{
	...
	switch animation
	{
		...
		case ANI_WAIT:
			...
			var _duration =
			[
				180, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 48
			];
			
			ani_start(spr_egg_idle, _duration, 0, 3, _order);
		...
		case ANI_DUCK:
			...
			ani_start(spr_egg_duck, 4, 0, 1);
			
		break;
		
		case ANI_LOOKUP:
			ani_start(spr_egg_lookup, 4, 0, 1);
		break;
