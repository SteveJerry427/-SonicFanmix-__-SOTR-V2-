/// @function scr_player_animate_mila
function scr_player_animate_mila()
{
	...
	switch animation
	{
		...
		case ANI_WAIT:
			...
			[
				...
				16, 32, 16, 
				128, 64, 16, 16, 16, 128, 64, 16, 16, 16, 128, 64, 16, 16, 16, 128, 64, 16, 16, 16
				
			];
			
			ani_start(spr_mila_idle, _duration, 0, 32, _order);
		...
		case ANI_SPIN:
			...
			{
				ani_start(spr_mila_spin, 0, 0, 0, [0, 4, 1, 4, 2, 4, 3, 4]);
			}
		...
		case ANI_DUCK:	
			ani_start(spr_mila_duck, 6, 0, 1);
		break;
		
		case ANI_LOOKUP:	
			ani_start(spr_mila_lookup, 4, 0, 1);
		break;
