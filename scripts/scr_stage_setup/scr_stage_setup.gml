...
function scr_stage_setup()
{
	...
	switch room
	{
		...
		case rm_stage_tsz0:
			...
			m_stage_set(35, "TECH STADIUM", ACT_SINGLE, bgm_woofle, m_local_random_animals(_animal_array), 1024, 1536, rm_devmenu, true);
		...
		m_stage_set(1, "PLANETOID PORT", ACT_SINGLE, bgm_ppz_bountifulstar, m_local_random_animals(_animal_array), 1088, 1024, rm_stage_nlz1_v2, true);
		...
		// Background
			...
			bg_add_layer(spr_nlz1_bg_layer0_v2, 0, 384, -32, 0, 0, 0, 0, 0.050);				
			bg_set_perspective_x(0, 0);
			...
			bg_set_perspective_x(0.05, 0);
			bg_add_layer(spr_nlz1_bg_layer4_v2, 0, 256, 0, 0, 0, 0, 0.04, 0.065);				
			bg_set_perspective_x(0.04, 0);
			bg_add_layer(spr_nlz1_bg_layer5_v2, 0, 384, 0, 0, 0, 0, 0.05, 0.070);				
			bg_set_perspective_x(0.05, 0);
			bg_add_layer(spr_nlz1_bg_layer6_v2, 0, 240, 0, 0, 0, 0, 0.075, 0.075);				
			bg_set_perspective_x(0.075, 0);
			bg_add_layer(spr_nlz1_bg_layer7_v2, 0, 256, 0, 0, 0, 0, 0.1, 0.080);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_nlz1_bg_layer8_v2, 0, 288, 0, 0, 0, 0, 0.125, 0.09);				
			bg_set_perspective_x(0.125, 0);
			bg_add_layer(spr_nlz1_bg_layer9_v2, 0, 384, 0, 0, -0.1, 0, 0.15, 0.09);
			bg_set_perspective_x(0.15, 2);
			bg_add_layer(spr_nlz1_bg_layer10_v2, 0, 432, 0, 0, 0, 0, 0.175, 0.1);				
			bg_set_perspective_x(0.175, 0);
			bg_add_layer(spr_nlz1_bg_layer11_v2, 0, 353, 32, 0, 0, 0, 0.20, 0.1125);				
			bg_set_perspective_x(0.20, 0);
			bg_add_layer(spr_nlz1_bg_layer12_v2, 0, 432, 48, 0, 0, 0, 0.225, 0.125);				
			bg_set_perspective_x(0.225, 0);
			bg_add_layer(spr_nlz1_bg_layer13_v2, 0, 640, 96, 0, 0, 0, 0.25, 0.15);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_nlz1_bg_layer14_v2, 0, 401, 208, 0, 0, 0, 0.30, 0.2);				
			bg_set_perspective_x(0.30, 0);
			bg_add_layer(spr_nlz1_bg_layer15, 0, 640, 416, 0, 0, 0, 0.35, 0.3);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_nlz1_bg_layer16, 0, 640, 544, 0, 0, 0, 0.375, 0.35);				
			bg_set_perspective_x(0.375, 0);
			bg_add_layer(spr_nlz1_bg_layer17_b, 0, 640, 592, 0, 0, 0, 0.4, 0.355);				
			bg_set_perspective_x(0.4, 0);
			bg_add_layer(spr_nlz1_bg_layer17, 0, 704, 592, 0, 0, 0, 0.425, 0.355);				
			bg_set_perspective_x(0.425, 0);
			bg_add_layer(spr_nlz1_bg_layer18, 0, 704, 608, 0, 0, 0, 0.45, 0.36);				
			bg_set_perspective_x(0.45, 0);
			bg_add_layer(spr_nlz1_bg_layer19, 0, 608, 624, 0, 0, 0, 0.475, 0.365);				
			bg_set_perspective_x(0.475, 0);
			bg_add_layer(spr_nlz1_bg_layer20, 0, 688, 608, 0, 0, 0, 0.5, 0.37);				
			bg_set_perspective_x(0.5, 0);
		...
		m_stage_set(5, "SKYLINE SQUARE", 1, bgm_ssz2_loveyousonic, m_local_random_animals(_animal_array), 6780, -1, rm_stage_blz1, true);
		...
		// Background
			...
			bg_add_layer(spr_ssz2_bg_layer, 0, 16, 0, 0, 0, 0, 0.009, 0.050);	
			bg_add_layer(spr_ssz2_bg_layer, 16, 16, 16, 0, 0, 0, 0.008, 0.050);		
			bg_add_layer(spr_ssz2_bg_layer, 32, 16, 32, 0, 0, 0, 0.007, 0.050);
			bg_add_layer(spr_ssz2_bg_layer, 48, 16, 48, 0, 0, 0, 0.006, 0.050);
			bg_add_layer(spr_ssz2_bg_layer, 64, 16, 64, 0, 0, 0, 0.005, 0.050);
			bg_add_layer(spr_ssz2_bg_layer, 80, 720, 80, 0, 0, 0, 0.004, 0.050);
			bg_set_perspective_x(0.004, 16);
			bg_add_layer(spr_ssz2_bg_layer1, 0, 1280, 0, 0, 0, 0, 0.01, 0.055);				
			bg_set_perspective_x(0.01, 0);
			bg_add_layer(spr_ssz2_bg_layer_2, 0, 32, 0, 0, -0.050, 0, 0.02, 0.052);	
			bg_add_layer(spr_ssz2_bg_layer_2, 32, 48, 32, 0, -0.1, 0, 0.02, 0.054);	
			bg_add_layer(spr_ssz2_bg_layer_2, 80, 64, 80, 0, -0.150, 0, 0.02, 0.056);	
			bg_add_layer(spr_ssz2_bg_layer_2, 256, 160, 128, 0, -0.2, 0, 0.03, 0.056);
			bg_set_perspective_x(0.03, 0);
			bg_add_layer(spr_ssz2_bg_layer_3, 0, 448, -128, 0, -0.095, 0, 0.06, 0.060);				
			bg_set_perspective_x(0.06, 0);
			bg_add_layer(spr_ssz2_test_layer_5, 0, 960, -128, 0, 0, 0, 0.08, 0.070);				
			bg_set_perspective_x(0.08, 0);
			bg_add_layer(spr_ssz2_bg_layerc, 0, 640, -112, 0, -0.15, 0, 0.08, 0.090);				
			bg_set_perspective_x(0.08, 0);
			bg_add_layer(spr_ssz2_bg_layer6, 0, 16, 736, 0, -1.5, 0, 0.10, 0.080);
			bg_add_layer(spr_ssz2_bg_layer6, 16, 16, 624, 0, 1.75, 0, 0.10, 0.085);
			bg_set_perspective_x(0.10, 0);
			bg_add_layer(spr_ssz2_test_layer_4, 0, 1440, -144, 0, 0, 0, 0.15, 0.090);				
			bg_set_perspective_x(0.15, 0);
			bg_add_layer(spr_ssz2_bg_layerc_1, 0, 608, -64, 0, -0.275, 0, 0.15, 0.11);				
			bg_set_perspective_x(0.15, 0);
			bg_add_layer(spr_ssz2_bg_layer8, 0, 352, -64, 0, 0.1, 0, 0.175, 0.090);				
			bg_set_perspective_x(0.175, 0);
			bg_add_layer(spr_ssz2_test_layer_2, 0, 1440, -64, 0, 0, 0, 0.25, 0.11);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_ssz2_bg_layerc_2, 0, 656, 24, 0, -0.4, 0, 0.25, 0.15);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_ssz2_bg_layer12, 0, 384, 40, 0, 0.2, 0, 0.30, 0.11);				
			bg_set_perspective_x(0.30, 0);
			bg_add_layer(spr_ssz2_test_layer, 0, 1440, 0, 0, 0, 0, 0.35, 0.15);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_ssz2_bg_layer_r2, 0, 1024, -63, 0, -5, 0, 0.35, 0.175);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_ssz2_bg_layer_r1, 0, 1023, -63, 0, 6, 0, 0.4, 0.175);
			bg_add_layer(spr_ssz2_bg_layer_r1, 1024, 416, 960, 0, 0, 0, 0.4, 0.175);
			bg_set_perspective_x(0.4, 0);
			bg_add_layer(spr_ssz2_test_layer_3, 0, 1440, 64, 0, 0, 0, 0.5, 0.18);				
			bg_set_perspective_x(0.5, 0);
			bg_add_layer(spr_ssz2_bg_layerc_3, 0, 656, 128, 0, -0.5, 0, 0.45, 0.20);				
			bg_set_perspective_x(0.45, 0);
			bg_add_layer(spr_ssz2_test_layer_6, 0, 1440, 466, 0, 0, 0, 0.4, 0.25);
			bg_set_perspective_x(0.5, 0);
		...
		m_stage_set(6, "BRIDGE LAGOON", 0, bgm_blz1_BIZ1remsoda, m_local_random_animals(_animal_array), 1056, 2208, rm_stage_bpz1_v2, true);
		...
		// Background
			...
			bg_set_perspective_x(0.06, 0);
			bg_add_layer(spr_blz1_bg_layer2, 0, 400, -60, 0, -0.03, 0, 0.03, 0.03);				
			bg_set_perspective_x(0.03, 0);
		...
		m_stage_set(7, "BRIDGE LAGOON", 1, bgm_blz2_LCZ1JX16bit, m_local_random_animals(_animal_array), 3000, 1500, rm_stage_bpz1_v2, true);
		...
		case rm_stage_bpz1_v2:
		
		m_stage_set(8, "BLOCKSIDE PARK", 0, bgm_bpz1_maze1, m_local_random_animals(_animal_array), 1500, -1, rm_stage_sgz1_v2, true);
		
		player_spawn(100, 1408, global.player_main, "Objects");
		player_spawn(70, 1408, global.player_cpu, "Objects");
		...
		m_stage_set(9, "BLOCKSIDE PARK", 1, bgm_bpz2alt_slimyspring, m_local_random_animals(_animal_array), 2944, 1344, rm_stage_sgz1_v2, true);
		
		player_spawn(10, 255, global.player_main, "Objects");
		player_spawn(10, 255, global.player_cpu, "Objects");
		
		collision_load_binary("widths_tsz", "heights_tsz", "angles_tsz", "CollisionA", "CollisionB");
		
		// Background
			
			bg_add_layer(spr_bpz2_bg_layer, 0, 960, 0, 0, 0, 0, 0.1, 0);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_bpz2_bg_layer_1, 0, 176, 545, 0, -0.1, 0, 0.2, 0);
			bg_set_perspective_x(0.6, 2);
			bg_set_perspective_y(water_level_init);
		...
		m_stage_set(10, "SPRING GARDENS", 0, bgm_sgz1alt_SYYM2_SR, m_local_random_animals(_animal_array), 3072, -1, rm_stage_sgz2_v2, true);
		...
		// Background
			...
			bg_add_layer(spr_sgz1_bg_layer, 0, 656, 0, 0, 0, 0, 0, 0.01);				
			bg_set_perspective_x(0, 0);
			bg_add_layer(spr_sgz1_bg_layer_1, 0, 80, 0, 0, -0.06, 0, 0.015, 0.0175);	
			bg_add_layer(spr_sgz1_bg_layer_1, 80, 80, 64, 0, -0.08, 0, 0.015, 0.0175);
			bg_set_perspective_x(0.015, 0);
			bg_add_layer(spr_sgz1_bg_layer_2, 0, 656, -32, 0, 0, 0, 0.01, 0.02);				
			bg_set_perspective_x(0.01, 0);
			bg_add_layer(spr_sgz1_bg_layer_3, 0, 656, -32, 0, 0, 0, 0.03, 0.03);				
			bg_set_perspective_x(0.03, 0);
			bg_add_layer(spr_sgz1_bg_layer_4, 0, 304, -0, 0, 0, 0, 0.05, 0.04);				
			bg_set_perspective_x(0.05, 0);
			bg_add_layer(spr_sgz1_bg_layer_5, 0, 304, 0, 0, 0, 0, 0.1, 0.05);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_sgz1_bg_layer_6, 0, 336, -48, 0, 0, 0, 0.15, 0.06);				
			bg_set_perspective_x(0.15, 0);
			bg_add_layer(spr_sgz1_bg_layer_7, 0, 656, -32, 0, 0, 0, 0.2, 0.07);				
			bg_set_perspective_x(0.2, 0);
			bg_add_layer(spr_sgz1_bg_layer_8, 0, 656, -32, 0, 0, 0, 0.225, 0.07);				
			bg_set_perspective_x(0.225, 0);
			bg_add_layer(spr_sgz1_bg_layer_9, 0, 656, -32, 0, 0, 0, 0.25, 0.07);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_sgz1_bg_layer_10, 0, 656, 48, 0, 0, 0, 0.275, 0.1);				
			bg_set_perspective_x(0.275, 0);
			bg_add_layer(spr_sgz1_bg_layer_11, 0, 656, 144, 0, 0, 0, 0.3, 0.2);				
			bg_set_perspective_x(0.3, 0);
			bg_add_layer(spr_sgz1_bg_layer_12, 0, 656, 144, 0, -3, 0, 0.32, 0.2);				
			bg_set_perspective_x(0.32, 0);
			bg_add_layer(spr_sgz1_bg_layer_13, 0, 656, 144, 0, 0, 0, 0.35, 0.2);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_sgz1_bg_layer_14, 0, 656, 144, 0, 0, 0, 0.25, 0.2);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_sgz1_bg_layer_15, 0, 656, 144, 0, 2, 0, 0.3, 0.2);				
			bg_set_perspective_x(0.3, 0);
			bg_add_layer(spr_sgz1_bg_layer_16, 0, 656, 144, 0, 0, 0, 0.35, 0.2);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_sgz1_bg_layer_17, 0, 656, 144, 0, -3, 0, 0.4, 0.2);				
			bg_set_perspective_x(0.4, 0);
			bg_add_layer(spr_sgz1_bg_layer_18, 0, 688, 144, 0, 0, 0, 0.45, 0.2);				
			bg_set_perspective_x(0.45, 0);
		...
		m_stage_set(11, "SPRING GARDENS", 1, bgm_sgz2_midnightgreenhousermx, m_local_random_animals(_animal_array), 3968, 2944, rm_devmenu, true);
		
		player_spawn(55, 1536, global.player_main, "Objects");
		player_spawn(55, 1536, global.player_cpu, "Objects");
		...
		// Background
			...
			bg_set_perspective_x(0.02, 0);
			bg_add_layer(spr_sgz2_bg_layer3, 0, 201, 0, 0, -1, 0, 0, 0.001);	
			bg_add_layer(spr_sgz2_bg_layer3, 201, 8, 201, 0, 1, 0, 0, 0.001);
			bg_add_layer(spr_sgz2_bg_layer3, 209, 8, 209, 0, -1.5, 0, 0, 0.001);	
			bg_add_layer(spr_sgz2_bg_layer3, 217, 8, 217, 0, 1.5, 0, 0, 0.001);	
			bg_set_perspective_x(0, 0);
			...
			bg_set_perspective_x(0.5, 0);
			bg_add_layer(spr_sgz2_bg_layer15, 0, 896, -16, 0, 0, 0, 0.55, 0.001);				
			bg_set_perspective_x(0.55, 0);
			bg_add_layer(spr_sgz2_bg_layer16, 0, 896, -32, 0, 0, 0, 0.575, 0.001);				
			bg_set_perspective_x(0.575, 0);
			bg_add_layer(spr_sgz2_bg_layer17, 0, 896, -32, 0, 0, 0, 0.6, 0.001);				
			bg_set_perspective_x(0.6, 0);
			bg_add_layer(spr_sgz2_bg_layer19, 0, 896, 16, 0, 0, 0, 0.7, 0.001);				
			bg_set_perspective_x(0.7, 0);
			bg_add_layer(spr_sgz2_bg_layer20, 0, 896, 96, 0, 0, 0, 0.8, 0.001);				
			bg_set_perspective_x(0.8, 0);
		...
		m_stage_set(13, "AQUA NEXUS", 0, bgm_ddz1_searchformydreams, m_local_random_animals(_animal_array), 2560, -1, rm_stage_ddz2, true);
		
		player_spawn(100, 1152, global.player_main, "Objects");
		player_spawn(70, 1152, global.player_cpu, "Objects");
		...
		m_stage_set(14, "AURORA ICEFIELD", 0, bgm_aiz2_fairyofaif, m_local_random_animals(_animal_array), 2000, -1, rm_stage_aiz2, true);
		...
		m_stage_set(15, "AURORA ICEFIELD", 1, bgm_aiz2_fairyofaif, m_local_random_animals(_animal_array), 2000, -1, rm_stage_esz1, true);
		...
		m_stage_set(16, "EGGSERVATORY", 0, bgm_esz1_degeneracyyamajet, m_local_random_animals(_animal_array), 2544, 2432, rm_stage_esz2, true);
		...
		m_stage_set(18, "HILLTOP HEIGHTS", ACT_SINGLE, bgm_hhz, m_local_random_animals(_animal_array), 4000, -1, rm_devmenu, true);
		...
		collision_load_binary("widths_tsz", "heights_tsz", "angles_tsz", "CollisionA", "CollisionB");
		 ...
		 // Background
			bg_add_layer(spr_hhz_layer_0, 0, 1280, 0, 0, 0, 0, 0, 0.20);				
			bg_set_perspective_x(0, 0);
			bg_add_layer(spr_hhz_layer_1, 0, 1280, 0, 0, -0.05, 0, 0.05, 0.20);				
			bg_set_perspective_x(0.05, 0);
			bg_add_layer(spr_hhz_layer_2, 0, 1280, 0, 0, -0.1, 0, 0.075, 0.20);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_hhz_layer_3, 0, 1280, 0, 0, 0, 0, 0.1, 0.225);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_hhz_layer_4, 0, 1280, 0, 0, 0, 0, 0.125, 0.225);				
			bg_set_perspective_x(0.125, 0);
			bg_add_layer(spr_hhz_layer_5, 0, 1280, 0, 0, 0, 0, 0.1, 0.225);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_hhz_layer_6, 0, 1280, 0, 0, 0, 0, 0.2, 0.25);				
			bg_set_perspective_x(0.2, 0);
			bg_add_layer(spr_hhz_layer_7, 0, 1280, 0, 0, -0.2, 0, 0.15, 0.2);				
			bg_set_perspective_x(0.15, 0);
			bg_add_layer(spr_hhz_layer_8, 0, 1280, 0, 0, 0, 0, 0.2, 0.225);				
			bg_set_perspective_x(0.2, 0);
			bg_add_layer(spr_hhz_layer_9, 0, 1280, 96, 0, 0, 0, 0.25, 0.225);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_hhz_layer_10, 0, 1280, 96, 0, 0, 0, 0.3, 0.25);				
			bg_set_perspective_x(0.3, 0);
			bg_add_layer(spr_hhz_layer_11, 0, 1280, 256, 0, 0, 0, 0.35, 0.30);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_hhz_layer_12, 0, 1280, 256, 0, 0, 0, 0.4, 0.30);				
			bg_set_perspective_x(0.4, 0);
		...
		m_stage_set(19, "SKY FORTRESS", ACT_SINGLE, bgm_sfz_sfz216bit, m_local_random_animals(_animal_array), 4000, -1, rm_devmenu, true);
		...
		collision_load_binary("widths_tsz", "heights_tsz", "angles_tsz", "CollisionA", "CollisionB");
		  ...
		  // Background
			bg_add_layer(spr_hhz_layer_0, 0, 1280, 0, 0, 0, 0, 0, 0.20);				
			bg_set_perspective_x(0, 0);
			bg_add_layer(spr_hhz_layer_1, 0, 1280, 0, 0, -0.15, 0, 0.05, 0.20);				
			bg_set_perspective_x(0.05, 0);
			bg_add_layer(spr_hhz_layer_2, 0, 1280, 0, 0, -0.4, 0, 0.1, 0.20);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_hhz_layer_3, 0, 1280, 0, 0, 0, 0, 0.1, 0.225);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_hhz_layer_4, 0, 1280, 0, 0, 0, 0, 0.125, 0.225);				
			bg_set_perspective_x(0.125, 0);
			bg_add_layer(spr_hhz_layer_5, 0, 1280, 0, 0, -0.3, 0, 0.1, 0.225);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_hhz_layer_6, 0, 1280, 0, 0, -0.6, 0, 0.2, 0.25);				
			bg_set_perspective_x(0.2, 0);
			bg_add_layer(spr_hhz_layer_7, 0, 1280, 0, 0, -0.8, 0, 0.2, 0.2);				
			bg_set_perspective_x(0.3, 0);
			bg_add_layer(spr_hhz_layer_8, 0, 1280, 0, 0, 0, 0, 0.2, 0.225);				
			bg_set_perspective_x(0.2, 0);
			bg_add_layer(spr_hhz_layer_9, 0, 1280, 96, 0, 0, 0, 0.25, 0.225);				
		...
		m_stage_set(20, "UTSUROSHIMA LOOP", 0, bgm_ulz_r_morishima_tokio, m_local_random_animals(_animal_array), 992, 960, rm_devmenu, true);
		...
		m_stage_set(21, "AZURE CARNIVAL", 1, bgm_acz_r_v2_nopeslope, m_local_random_animals(_animal_array), 1280, 1088, rm_devmenu, true);
		...
		m_stage_set(22, "WAHOO RACEWAY", 2, bgm_wr3z, m_local_random_animals(_animal_array), 2000, -1, rm_devmenu, true);
		
		player_spawn(100, 1792, global.player_main, "Objects");
		player_spawn(70, 1792, global.player_cpu, "Objects");
		...
		m_stage_set(23, "BORDER SPACE", ACT_SINGLE, bgm_bsz_c_bop_it_comet, m_local_random_animals(_animal_array), 4000, 0, rm_devmenu, true);
		...
		m_stage_set(24, "BIG HILL", ACT_SINGLE, bgm_ccz_golf_spectate1, m_local_random_animals(_animal_array), 12000, -1, rm_devmenu, true);
		...
		m_stage_set(25, "NEVER LAKE", 0, bgm_nlz1_bb8, m_local_random_animals(_animal_array), 2000, -1, rm_stage_nlz2, false);
		...
		m_stage_set(26, "NEVER LAKE", 1, bgm_nlz2_theboom, m_local_random_animals(_animal_array), 2944, 1968, rm_stage_ssz1, true);
		...
		m_stage_set(27, "SKYLINE SQUARE", 0, bgm_ssz1alt_mushroombridgermx, m_local_random_animals(_animal_array), 2000, -1, rm_stage_blz1, false);
		...
		m_stage_set(28, "SKYLINE SQUARE", 0, bgm_ssz1_wearefree, m_local_random_animals(_animal_array), 2048, -1, rm_stage_blz1_v2, false);
		...
		m_stage_set(29, "SKYLINE SQUARE", 1, bgm_ssz2_loveyousonic, m_local_random_animals(_animal_array), 2880, -1, rm_stage_blz1, true);
	...
	case rm_stage_blz1:
		...
		m_stage_set(30, "BRIDGE LAGOON", 0, bgm_blz1old_BIZ1JX16bit, m_local_random_animals(_animal_array), 2000, -1, rm_stage_bpz1, false);
		...
		// Background
			...
			case rm_stage_blz1_v3:
		
		m_stage_set(31, "BRIDGE LAGOON", 0, bgm_blz1_BIZ1remsoda, m_local_random_animals(_animal_array), 1056, 2208, rm_stage_bpz1_v2, true);
		...
		m_stage_set(32, "BLOCKSIDE PARK", 0, bgm_bpz1_maze1, m_local_random_animals(_animal_array), 1500, -1, rm_stage_sgz1, true);
		...
		m_stage_set(33, "SPRING GARDENS", 0, bgm_sgz1_springsend, m_local_random_animals(_animal_array), 2960, -1, rm_devmenu, true);
		...
		// Background
			...
			bg_add_layer(spr_sgz1_bg_layer0_old, 0, 560, -64, 0, 0, 0, 0, 0.01);				
			bg_set_perspective_x(0, 0);
			bg_add_layer(spr_sgz1_bg_layer1_old, 0, 48, 0, 0, -0.02, 0, 0, 0.01);
			bg_add_layer(spr_sgz1_bg_layer1_old, 48, 512, 48, 0, -0.04, 0, 0, 0.015);
			bg_set_perspective_x(0.015, 0);
			bg_add_layer(spr_sgz1_bg_layer2_old, 0, 560, -48, 0, 0, 0, 0.01, 0.02);				
			bg_set_perspective_x(0.01, 0);
			bg_add_layer(spr_sgz1_bg_layer3_old, 0, 560, -32, 0, 0, 0, 0.03, 0.03);				
			bg_set_perspective_x(0.03, 0);
			bg_add_layer(spr_sgz1_bg_layer4_old, 0, 560, -16, 0, 0, 0, 0.05, 0.04);				
			bg_set_perspective_x(0.05, 0);
			bg_add_layer(spr_sgz1_bg_layer5_old, 0, 560, 0, 0, 0, 0, 0.1, 0.05);				
			bg_set_perspective_x(0.1, 0);
			bg_add_layer(spr_sgz1_bg_layer6_old, 0, 560, 16, 0, 0, 0, 0.15, 0.06);				
			bg_set_perspective_x(0.15, 0);
			bg_add_layer(spr_sgz1_bg_layer7_old, 0, 560, 32, 0, 0, 0, 0.2, 0.07);				
			bg_set_perspective_x(0.2, 0);
			bg_add_layer(spr_sgz1_bg_layer8_old, 0, 560, 48, 0, 0, 0, 0.25, 0.08);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_sgz1_bg_layer9_old, 0, 560, 64, 0, 0, 0, 0.3, 0.09);				
			bg_set_perspective_x(0.3, 0);
			bg_add_layer(spr_sgz1_bg_layer10_old, 0, 560, 224, 0, 0, 0, 0.25, 0.2);				
			bg_set_perspective_x(0.25, 0);
			bg_add_layer(spr_sgz1_bg_layer11_old, 0, 560, 240, 0, -1.5, 0, 0.3, 0.2);				
			bg_set_perspective_x(0.3, 0);
			bg_add_layer(spr_sgz1_bg_layer12_old, 0, 560, 240, 0, 0, 0, 0.35, 0.2);				
			bg_set_perspective_x(0.35, 0);
			bg_add_layer(spr_sgz1_bg_layer13_old, 0, 560, 256, 0, 3, 0, 0.4, 0.2);				
			bg_set_perspective_x(0.4, 0);
			bg_add_layer(spr_sgz1_bg_layer14_old, 0, 560, 256, 0, 0, 0, 0.45, 0.2);				
			bg_set_perspective_x(0.45, 0);
			bg_add_layer(spr_sgz1_bg_layer16_old, 0, 560, 208, 0, 0, 0, 0.5, 0.2);				
			bg_set_perspective_x(0.5, 0);
		...
		m_stage_set(34, "AZURE CARNIVAL", 1, bgm_acz_r_joinus4happytime, m_local_random_animals(_animal_array), 1088, 912, rm_devmenu, true);
